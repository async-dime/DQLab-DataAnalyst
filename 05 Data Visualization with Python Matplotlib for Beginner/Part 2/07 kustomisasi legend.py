...
Kustomisasi Legend
  ...
  - loc: 
      untuk menentukan posisi legend, berikut beberapa lokasi legend yang bisa didefinisikan:
  ...
  - bbox_to_anchor: 
      biasanya digunakan untuk adjust lokasi dari legend. Bisa berisi 2 angka yang menunjukkan koordinat x dan y (misal (1.6,0.5) berarti geser 1.6 ke kanan dan 0.5 ke atas). Bisa juga berisi 4 angka, angka ketiga dan keempat menyatakan width (lebar) dan height (tinggi) dari legend.
  - shadow: 
      jika diisi True, maka kotak legend akan memiliki bayangan.
  - ncol: 
      jumlah kolom dari isi legend, default-nya adalah 1
  - fontsize: 
      ukuran huruf pada legend
  - title: 
      memberikan judul pada legend
  - title_fontsize: 
      ukuran huruf pada judul legend
'''
