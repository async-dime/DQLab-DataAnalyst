'''
Syntax dalam praktik membuat bar chart mirip dengan line chart:
tentukan nilai untuk sumbu-x dan sumbu-y, lalu tambahkan parameter kind='bar' seperti berikut ini:
'''
